      ...
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 text-balance">
            <SplitText
              text="De tu computadora al mundo en un clic"
          ...
          <div className="text-xl text-muted-foreground mb-10 max-w-2xl mx-auto text-pretty leading-relaxed">
            <BlurText
              text="Hosting creado especialmente para estudiantes. Despliegue casi inmediato de tus proyectos con soporte personalizado y precios accesibles."
              delay={150}
              animateBy="words"
              direction="top"
            />
