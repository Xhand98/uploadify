        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input id="nombre" placeholder="Tu nombre" required className="bg-background" />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="asunto" placeholder="¿En qué podemos ayudarte?" required className="bg-background" />
          </div>
